...
function createCanvasRadialGradient(ctx, type, position, colorStops, width, height) {
    let gradient;
...
var QRCode = /** @class */ (function (_super) {
    ...
    QRCode.prototype.drawCircle = function (lineWidth, lineColor, x, y, radius, fill, ctx) {
    ...
    QRCode.prototype.update = function () {
        ...
        var additionalquiteZoneForCircleOrRoundedBorder = 0;
        if (qrShape == 'circle') {
        ...
        if (borderWidth && !quietZone || quietZone < additionalquiteZoneForCircleOrRoundedBorder)
            quietZone += quietZone + additionalquiteZoneForCircleOrRoundedBorder;
        var canvasSize = size + (2 * quietZone) + borderSize;
        var length = qrCode.getModuleCount();
        var cellSize = (size + borderSize) / length;
        ...
        if (qrShape == 'circle') {
            ...
            ctx.fillStyle = createCanvasRadialGradient(ctx, "radial", { x: 0.5, y: 0.5, r: 0.3 }, [
                {
                  "value": "rgba(2,0,36,1)",
                  "left": 13
                },
                {
                  "value": "rgba(9,9,121,1)",
                  "left": 76
                },
                {
                  "value": "rgba(0,212,255,1)",
                  "left": 100
                }
              ]
        ...
        if (logoImage) {
            ...
            image_1.onload = function (e) {
                ...
                var dxLogo = ((size - dWidthLogo) / 2) + borderWidth;
                var dyLogo = ((size - dHeightLogo) / 2) + borderWidth;
        ...
        if (borderWidth > 0) {
            ...
            if (qrShape == 'circle') {
                ...
                this.drawRoundedSquare(borderWidth, 0, 0, canvasSize, borderColor, 50, false, ctx);
            }
            else if (qrShape == 'square') {
                this.drawRoundedSquare(borderWidth, 0, 0, canvasSize, borderColor, 0, false, ctx);
            }
        }
    };
    QRCode.prototype.render = function () {
        var _a;
        var qrSize = +this.props.size + (2 * +this.props.quietZone) + (2 * this.props.borderWidth);
